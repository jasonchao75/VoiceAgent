...
def test_default_registry_contains_only_real_flux_provider(runtime_config: RuntimeConfig) -> None:
    """ElevenLabs remains an extension point, not a fake runtime adapter."""
    registry = create_default_tts_registry()
    assert registry.providers == ("deepgram_flux",)
